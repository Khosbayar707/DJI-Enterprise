    ...
    <div className="bg-white min-h-screen">
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">Garmin Products</h1>
          ...
          {garmin.length > 0 ? (
            ...
            <div className="text-center text-gray-500 py-10">Бүтээгдэхүүн олдсонгүй.</div>
          )}
        </div>
      </section>
    </div>
