  ...
  return (
    <aside className="w-96 bg-muted p-6 flex flex-col gap-4 border-r">
      ...
      <Button
        ...
        color={activeSection === AdminSideBarOptions.products ? 'primary' : 'inherit'}
      ...
      <Button
        sx={{ justifyContent: 'flex-start' }}
        color={activeSection === AdminSideBarOptions.images ? 'primary' : 'inherit'}
      ...
      <Button
        sx={{ justifyContent: 'flex-start' }}
        color={activeSection === AdminSideBarOptions.orders ? 'primary' : 'inherit'}
      ...
      <Button
        sx={{ justifyContent: 'flex-start' }}
        color={activeSection === AdminSideBarOptions.DroneBuyRequest ? 'primary' : 'inherit'}
      ...
      <Button
        sx={{ justifyContent: 'flex-start' }}
        color={activeSection === AdminSideBarOptions.ContactRequest ? 'primary' : 'inherit'}
