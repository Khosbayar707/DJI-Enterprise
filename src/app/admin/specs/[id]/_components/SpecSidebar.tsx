  ...
  return (
    <aside className="w-64 bg-muted p-6 flex flex-col gap-4 border-r">
      ...
      <Button
        ...
        color={activeSection === SpecSideBarOptions.GENERAL ? 'primary' : 'inherit'}
      ...
      <Button
        sx={{ justifyContent: 'flex-start' }}
        color={activeSection === SpecSideBarOptions.IMAGES ? 'primary' : 'inherit'}
      ...
      <Button
        sx={{ justifyContent: 'flex-start' }}
        color={activeSection === SpecSideBarOptions.VIDEOS ? 'primary' : 'inherit'}
