...
const items = [
  ...
  },
  {
    ...
    details:
      "Бүсчилсэн хөгжлийн төлөвлөгөө, 3D орон зайн анализ, барилгын концепц дизайн гаргана.",
  },
  {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            “Инженер Геодези” ХХК-ийн үндсэн хэлтэс, үйлчилгээний чиглэлүүдийг
            танилцуулж байна. Дэлгэрэнгүй мэдээлэл авахын тулд карт дээр дарна
            уу.
          </p>
        </motion.div>
