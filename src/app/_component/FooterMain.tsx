      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <Accordion type="single" collapsible defaultValue="contact-info">
          <AccordionItem value="contact-info" className="border-0">
            <AccordionTrigger className="py-3 text-left text-sm font-semibold text-gray-700 hover:no-underline [&[data-state=open]]:text-blue-600 border-b border-gray-200">
