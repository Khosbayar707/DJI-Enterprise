  ...
  return (
    <Link href={`/dji/${drone.id}`} aria-label={`${drone.name} дэлгэрэнгүй`} target="_blank">
      <motion.div
        ...
        "
      >
        <div className="relative w-full overflow-hidden rounded-t-2xl bg-white dark:bg-gray-900">
          ...
          <span
            className="
              ...
              rounded-full
              bg-gray-900/85 dark:bg-black/70
        ...
        <div className="flex flex-1 flex-col p-3 sm:p-4">
          ...
          <p
            className="
              min-h-[44px] text-xs leading-relaxed
              text-gray-600 dark:text-gray-400
              line-clamp-3
              sm:min-h-[60px] sm:text-sm sm:line-clamp-4
            "
          >
          ...
          <button
            className="
              ...
              sm:mt-4 sm:px-4 sm:py-2.5 sm:text-base
            "
            aria-hidden
            tabIndex={-1}
          >
